...
- **PT-TTC-012**: `format.yaml` L4 `invoke` parse-aid (Anthropic-style `<invoke>`/`<parameter>`, not DSML). Compliance `ttc-012`/`ttc-013`. DeepSeek `known_dialects` records live V4 Pro evidence; not encouraged output.
